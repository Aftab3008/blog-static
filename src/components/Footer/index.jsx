    ...
    return (
        <footer className='mt-16 rounded-2xl bg-dark m-10 flex flex-col items-center text-light'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='mt-6 min-w-[384px] flex items-stretch bg-light p-2 rounded mx-4'>
                <input type="email" placeholder="Enter your email" {...register("email", { required: true, maxLength: 80 })} className='w-full bg-transparent pl-0 text-dark focus:border-dark focus:ring-0 border-0 border-b mr-2 pb-1' />
            ...
            <div className='flex items-center mt-8'>
                ...
                <a href='http://example.com' className='inline-block w-6 h-6 mr-4 fill-light'><GithubIcon className="hover:scale-125 transition-all ease duration-200" /></a>
            ...
            <div className='w-full mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between'>
                ...
                <div className='text0center'>
                    Made with &hearts; by <a href='http://devdreaming.com' className='underline'>Aftab</a>
                </div>
            </div>
        </footer>
    )
